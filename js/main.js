...
function slideImages() {
  ...
  if (currentPosition >= slideWidth * (totalSlides - visibleSlides + 1)) {
...
window.addEventListener('resize', () => {
  ...
  sliderTrack.style.transform = `translateX(0px)`; // Reset track position
});

setInterval(slideImages, 2000); // Slide every 2 seconds
